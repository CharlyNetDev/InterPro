            ...
            try
            {
                for (int i = 0; i < elementos; i++)
                {
                    if (listaDatosPrueba[i].TestCase.Equals("Alta_Exitosa_PlanServicioCamposObligatorios"))
                    {
                        ...
                        //
                        if (listaDatosPrueba[i].ConsutltaReporte.Equals("true"))
                        {
                            ElementosPlanServicioPrueba.ElementosPlanServicioCreditoReporte(driver).Click();
                        }

                        if (listaDatosPrueba[i].ServicioTarjeta.Equals("true"))
                        {
                            ElementosPlanServicioPrueba.ElementosPlanServicioCreditoAlertas(driver).Click();
                        }

                        if (listaDatosPrueba[i].ConsultaAlertas.Equals("true"))
                        {
